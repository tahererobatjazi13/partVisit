...
import com.partsystem.partvisitapp.databinding.CompInfoBinding
...
class Info @JvmOverloads constructor(
    ...
    private var iconDrawable: Drawable? = ContextCompat.getDrawable(context, R.drawable.ic_not_found)
        set(value) {
