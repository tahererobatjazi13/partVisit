...
@Database(
    entities = [ApplicationSettingEntity::class, VisitorEntity::class, VisitScheduleEntity::class,
        ...
        DiscountEntity::class, DiscountEshantyunsEntity::class, DiscountCustomersEntity::class,
        DiscountGroupsEntity::class, DiscountProductsEntity::class, DiscountStairsEntity::class,
        DiscountGiftsEntity::class, DiscountProductKindInclusionsEntity::class,
        DiscountProductKindsEntity::class, DiscountUsersEntity::class,
